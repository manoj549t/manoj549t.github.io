...
if (isAuthenticated()) {
	...
	window.location.replace(dbx.getAuthenticationUrl("https://manoj549t.github.io/note/dbxtest.html"));
}
...
DropboxBase.prototype.getDownloadRequest = function () {
  if (DropboxBase.prototype.downloadRequest === undefined) {
    DropboxBase.prototype.downloadRequest = __webpack_require__(20);
  }
...
DropboxBase.prototype.getUploadRequest = function () {
  if (DropboxBase.prototype.uploadRequest === undefined) {
    DropboxBase.prototype.uploadRequest = __webpack_require__(21);
  }
...
var getBaseURL = __webpack_require__(2);
...
var Promise = __webpack_require__(1).Promise;
var getBaseURL = __webpack_require__(2);
var httpHeaderSafeJson = __webpack_require__(4);
